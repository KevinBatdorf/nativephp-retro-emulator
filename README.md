...
[grab the demo APK](https://github.com/KevinBatdorf/nativephp-retro-emulator-demo/releases/latest)
and sideload it — all six systems, games included. Or build the
