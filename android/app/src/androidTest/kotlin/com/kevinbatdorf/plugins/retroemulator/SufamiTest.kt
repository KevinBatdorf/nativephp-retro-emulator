...
class SufamiTest {
    ...
    fun sufamiBaseBootsToMenu() {
        ...
        try {
            ...
            assert(core.loadRom(bios.readBytes(), null) == EmulatorCore.LOAD_OK) { "base should load" }
            repeat(10) { core.tick() }
    ...
    fun sufamiSlotGameBoots() {
        ...
        try {
            ...
            assert(core.loadRom(bios.readBytes(), null) == EmulatorCore.LOAD_OK) { "base + slot should load" }
            repeat(30) { core.tick() }
    ...
    fun sufamiDualCartBoots() {
        ...
        try {
            ...
            assert(core.loadRom(bios.readBytes(), null) == EmulatorCore.LOAD_OK) {
    ...
    fun bsxMemoryCartBoots() {
        ...
        try {
            ...
            assert(core.loadRom(bios.readBytes(), null) == EmulatorCore.LOAD_OK) { "BS-X base + cassette should load" }
