...
class BootSkipAllSystemsTest {
    ...
    private val combos = listOf(
        ...
        Triple("gbc", "ares", "legendofzeldalinksawakeningdx.gbc"),
        Triple("gbc", "sameboy", "legendofzeldalinksawakeningdx.gbc"),
        Triple("gbc", "ares", "pokemoncrystalversion.gbc"),
        Triple("gbc", "sameboy", "pokemoncrystalversion.gbc"),
