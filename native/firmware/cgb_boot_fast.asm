; SameBoy's CGB boot ROM (Expat license, see LICENSE-sameboy) built with FAST,
; minus the boot chime upstream keeps even in FAST builds. Assembled with
; rgbds against sameboy/BootROMs includes; the built binary is vendored here.
